...
<div class="conteudo">
    ...
    <form class="form-horizontal" method="GET" action="{{ route('tipousuarios.destroy', $tipousuario->id) }}">
        <div class="aba">
            <ul class="nav nav-tabs" style="margin-bottom: 10px; margin-top: -10px;">
                ...
                <li><a href="#" style="cursor: pointer;">Permissões</a></li>
            </ul>
        </div>
        <div class="form1">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                  <input class="form-control" type="text" disabled ="disabled" name="nome" value="{{ $tipousuario->nome }}">
              </div>
            </div>
