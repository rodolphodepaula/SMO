...
<div class="conteudo">
    ...
    <form class="form-horizontal" method="post" action="{{ route('coordenadores.update', $coordenador->id ) }}">
        ...
        <div class="form4">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" name="nome" value="{{ $coordenador->nome }}">
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" name="crm" value="{{ $coordenador->crm }}">
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3">
                    <input class="form-control" type="date" name="data_inicio" value="{{ $coordenador->data_inicio }}">
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-3">
                    <input class="form-control" type="date" name="data_fim" value="{{ $coordenador->data_fim }}">
                </div>
            </div>
