...
<div class="conteudo">
    ...
    <form class="form-horizontal" method="post" action="{{ route('tipoatendimentos.update', $tipoatendimento->id) }}">
        <div class="form1">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                  <input class="form-control" type="text" name="nome" value="{{ $tipoatendimento->nome }}">
              </div>
            </div>
