...
<div class="conteudo">
    <div class="titulo">
        <h2>Administração de Tipo de Atendimento</h2>
    </div>
    ...
    <form class="form-horizontal" method="post" action="{{ route('tipoatendimentos.store') }}">
        <div class="form1">

            <input type="hidden" name="_token" value="{{csrf_token()}}">
            <div class="form-group form-group-sm">
                <label class="control-label col-sm-3" for="nome">Tipo de Atendimento:</label>
              <div class="col-sm-8">
