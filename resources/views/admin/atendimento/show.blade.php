...
<div class="conteudo"> 
    ...
    <form class="form-horizontal" method="GET" action="{{ route('atendimentos.destroy', $atendimento->id ) }}">
        <div class="form7">   
            ...
            <div class="form-central" style="margin-top: 35px;">
                <div class="form-group">
                  <button type="submit" class="btn btn-danger">
                    <i style="font-size: 20px;" class="glyphicon glyphicon-trash" aria-hidden="true"></i> Excluir Atendimento com todos Riscos e Exames
                  </button>
                </div>
            </div>  
        </div>     
