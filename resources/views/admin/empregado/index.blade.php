...
<div class="conteudo">
    ...
    <div class="form-search" style="margin-bottom:20px; ">
        <form class="form form-inline" method="get" action="{{ route('empregados.search') }}">
    ...
    <div class="form-central" style="margin-top: 0px;">
        <div class="btn btn-primary" style="margin-bottom: 10px;">
            <a href="{{ route('empregados.create') }}" style="color: #FFF;">
    ...
    <table class="table table-striped table-condensed table-hover">
        ...
        <tr>
            ...
            <td>{{$empregado->cpf}}</td>
            <td>{{$empregado->funcao['nome']}}</td>
            <td width="100">
                <a href="{{route('empregados.edit', $empregado->id)}}" class="btn btn-primary btn-sm" style="color: #FFF; margin-right: 5px;">
    ...
    {!! $empregados->appends($dataForm)->links() !!}
