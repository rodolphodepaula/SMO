...
<div class="conteudo">
    ...
    <form name="personForm" id="personForm" class="form-horizontal" method="post" action="{{ route('empregados.update', $empregado->id) }}"
    data-funcoes-url="{{ route('load_funcoes') }}" data-grupos-url="{{ route('load_grupos') }}">
        <div class="form6">   
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                  <input class="form-control" type="text" name="nome" value="{{ $empregado->nome }}">
              </div>
            </div>  
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-3">
                  <input class="form-control" type="text" name="cpf" id="cpf" value="{{ $empregado->cpf }}">
              </div>
            </div>
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text" name="ctps" value="{{ $empregado->ctps }}">
                </div>
                <label class="control-label col-sm-2" for="serie">Série:</label>
                <div class="col-sm-2">
                    <input class="form-control" type="text" name="serie" value="{{ $empregado->serie }}">
                </div>
            </div>
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-3">
                  <input class="form-control" type="date" name="data_nascimento" value="{{ $empregado->data_nascimento }}">
              </div>
            </div>
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-3">
                  <input class="form-control" type="date" name="data_admissao" value="{{ $empregado->data_admissao }}">
              </div>
            </div> 
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-3">
                  <input class="form-control" type="date" name="data_demissao" value="{{ $empregado->data_demissao }}">
              </div>
            </div>
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                    <select class="form-control" name="setor_id" id="setor_id">
                        ...
                        @if ($setor->id == $empregado->setor_id)
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                    <select class="form-control" name="funcao_id" id="funcao_id">
                        ...
                        @if ($funcao->id == $empregado->funcao_id)
              ...
              <div class="col-sm-8">
                    <select class="form-control" name="grupo_id" id="grupo_id">
                        ...
                        @foreach($grupos as $grupo)
                            @if ($grupo->id == $empregado->grupo_id)
