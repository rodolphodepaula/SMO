...
<div class="conteudo">
    ...
    <form class="form-horizontal" method="GET" action="{{ route('exames.destroy', $exame->id) }}">
        <div class="form1">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                  <input class="form-control" type="text" disabled="disabled" name="nome" value="{{ $exame->nome }}">
              </div>
            </div>
