...
<div class="conteudo">
    ...
    <form class="form-horizontal" method="GET" action="{{ route('grupos.destroy', $grupo->id) }}">
        <div class="aba">
            <ul class="nav nav-tabs" style="margin-bottom: 10px; margin-top: -10px;">
                ...
                <li><a href="#" style="cursor: pointer;">Funções X Setores</a></li>
                <li><a href="#" style="cursor: pointer;">Riscos</a></li>
                <li><a href="#" style="cursor: pointer;">Exames</a></li>
            </ul>
        </div>
        <div class="form1">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-8">
                  <input class="form-control" disabled="disabled" type="text" name="nome" value="{{ $grupo->nome }}">
              </div>
            </div>
